                ...
                ?>
                    ...
                    <tbody><?php foreach ($stored_resultset as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="full_width" value="<?php echo $row['old_url']; ?>" name="301_redirect_from[]">
                                    <input type="hidden" name="editid[]" value="<?php echo $row['ID']; ?>" />
                                </td>
                                <td class="icon_cover">»</td>
                                <td>
                                    <input type="text" class="full_width" value="<?php echo $row['new_url']; ?>" name="301_redirect_to[]">
                                </td>
                                <td class="padding_left_0">
                                    <a class="color_red"
                                       href="<?php echo wp_nonce_url(add_query_arg(array('action' => 'delete', 'delete-id' => absint($row['ID']))), 'delete-action' . $row['ID'], 'delete_nonce'); ?>"
    ...
    function TDRD_delete_redirection_links() {
        ...
        if(isset($_POST['filter-post'])){
            ...
            if(isset($_GET['search']) && $_GET['search'] != ''){
                $search_arg = "&search=".$_GET['search'];
            }
            $post_type = $_POST['trash-post-types'];
        ...
        if(isset($_POST['tra-search-submit'])){
            ...
            if(isset($_GET['trash_post_type']) && $_GET['trash_post_type'] != ''){
                $post_type_arg = "&trash_post_type=".$_GET['trash_post_type'];
            }
            $search_text = $_POST['tra-search-input'];
