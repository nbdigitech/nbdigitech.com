                    ...
                    <table id="datatables" class="table table-no-bordered" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th style="font-weight: bold;">View Ref</th>
                        ...
                        <tr>
                          ...
                          <td>{{$row->Date}}</td>
                           <td  style="cursor:pointer">
                              <a href="{{url('/Admin/RefUser',$row->Email)}}" class="btn btn-success">
                                View
                              </a>
                            </td>
                          
                            <td data-toggle="modal" data-target="#SndRemark" style="cursor:pointer" onclick="Remark('{{$row->id}}','{{$row->Remark}}')">
