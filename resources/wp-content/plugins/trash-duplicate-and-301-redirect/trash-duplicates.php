...
if (!function_exists('tdr_admin_scripts')) {
    ...
    function tdr_admin_scripts($hook_suffix) {
...
if(!function_exists('tdrd_submit_optin')) {
    function tdrd_submit_optin() {
        ...
        if(isset($_POST['email'])) {
            $tdrd_email = $_POST['email'];
        }
        else {
            $tdrd_email = get_option('admin_url');
        }
        if(isset($_POST['type'])) {
            $tdrd_submit_type = $_POST['type'];
        }
            ...
            <div class="useful_plugins">
                ...
                <div class="help-wrapper">
                    <div class="pro-content">
                        ...
                        <p class="pricing_change"><?php _e("Now only at", 'trash-duplicate-and-301-redirect') ?> <ins>$15</ins></p>
                    </div>
...
register_deactivation_hook(__FILE__, 'tdrdUpdateOptin');

if (!function_exists('tdrdUpdateOptin')) {

    function tdrdUpdateOptin() {
        update_option('tdrd_is_optin','');       
    }
