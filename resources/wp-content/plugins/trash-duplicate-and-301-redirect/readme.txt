...
Donate link: https://www.solwininfotech.com/product/wordpress-plugins/trash-duplicate-and-301-redirect/
...
= Buy Trash Duplicate and 301 Redirect PRO : =
<a rel="nofollow" href="https://codecanyon.net/item/trash-duplicate-and-301-redirect-pro-for-wordpress/20885697?ref=solwin">https://codecanyon.net/item/trash-duplicate-and-301-redirect-pro-for-wordpress/20885697?ref=solwin</a>

= Support =
If you find any issue please ask questions on [support forum](https://wordpress.org/support/plugin/trash-duplicate-and-301-redirect) or [support.solwininfotech.com](http://support.solwininfotech.com). We’re active for any support issues and feature suggestions. We will try to resolve your issues asap. So hope you will love it.
...
== Installation ==
1. Download the **trash-duplicate-and-301-redirect.zip** file and unzip it.
...
== Screenshots ==
1. Duplicate Posts Dashboard With Detail
2. Duplicate Posts With Dynamic Pagination
...
* Updated: Change text-domain to 'trash-duplicate-and-301-redirect' to make plugin compatible for translate.wordpress.org
...
* Updated: Make compatible with WordPress 4.8.1
* Fixed: Localization issue resolved
...
* Fixed: Redirection not working when special characters used in URL
