            ...
            <div class="col-md-12">
              <div class="card">
                  ...
                  <div style="background-color: #5BBC2E; padding: 10px; padding-left: 16px; padding-top:16px; border-radius: 3px;" style="width: 100%;">
                    <h4>Manage Users
                      <a href="{{route('Admin/Users/Add')}}" class="btn btn-success pull-right" style="margin-top: -7px; background-color: white; color:#E93F7A;">Add New</a></h4>
                  </div>
                  ...
                  @foreach($users as $row)
                        <tr>
                          ...
                          <td class="td-actions text-right">
                            ...
                            <button type="submit" rel="tooltip" class="btn btn-success" style="background-color: #E93F7A; padding:10px; padding-left: 20px; margin-right: 10px; padding-right: 20px;">
                              Edit
                            </button>
                            </form>
                            <button type="button" rel="tooltip" data-toggle="modal" data-target="#myModal" class="btn btn-danger pull-right" onclick="delete_function('{{$row->id}}')" style="background-color: #E93F7A; padding:10px; padding-left: 15px; padding-right: 15px;">
                              Delete
                            </button>
                          </td>
                        </tr>
