...
/* global constants */
defined( 'TVE_VERSION' ) || DEFINE( "TVE_VERSION", '1.500.19' );
...
add_action( 'wp_ajax_tve_autocomplete_posts', 'tve_autocomplete_posts' );
add_action( 'wp_ajax_nopriv_tve_autocomplete_posts', 'tve_autocomplete_posts' );
