...
<?php if ( get_theme_mod('hero_secondary')) { ?>
			<h2><?php echo esc_html( get_theme_mod( 'hero_secondary' ) ); ?></h2>
			<?php }else { ?>
...
<?php if ( get_theme_mod('hero_button_text') || get_theme_mod('hero_button_url') ) { ?>
			<div class="button"><p><a href="<?php echo esc_url( get_theme_mod('hero_button_url') ); ?>"><?php echo esc_html( get_theme_mod('hero_button_text') ); ?></a></p></div>
			<?php }else { ?>
...
<?php if ( get_theme_mod('hero_image') || get_theme_mod('hero_image_alt')) { ?>
			<div class="achimps"><img class="cc-credit-logo" src="<?php echo esc_url(get_theme_mod('hero_image') ); ?>" alt="<?php echo esc_html(get_theme_mod('hero_image_alt') ); ?>"/></div>
			<?php } else { ?>
	...
	<section class="cta">
		<div class="cta-content">
			<div class="featured-image">
				<img src="<?php echo esc_url(get_theme_mod('cta_image') ); ?>" />
			</div>
			<div class="content">
				<h2><?php echo esc_html(get_theme_mod('cta_text') ); ?></h2>
				<div class="first-button">
					<p><a href="<?php echo esc_html(get_theme_mod('cta_button_url') ); ?>"><?php echo esc_html(get_theme_mod('cta_button_text')); ?></a></p>
				</div>
				<div class="second-button">
					<p><a href="<?php echo esc_url(get_theme_mod('cta_second_button_url')); ?>"><?php echo esc_html(get_theme_mod('cta_second_button_text')); ?></a></p>
				</div>
			</div>
		</div>
	</section>
...
<section class="teaser">
	<div class="teaser-content">
		...
		<h3><?php echo esc_html( get_theme_mod('teaser_text') ); ?></h3>
		<?php } else { ?>
