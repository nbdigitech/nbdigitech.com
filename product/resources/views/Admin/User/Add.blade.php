  ...
  <div class="row">
        <div class="col-md-12">
              <form id="TypeValidation" class="form-horizontal" action="@if(isset($edit->id)) {{route('Admin/Users/Update')}} @else {{route('Admin/Users/Store')}} @endif" method="post">
                ...
                <div class="card ">
                  <div class="card-header card-header-rose card-header-text" style="background-color:#5BBC2E;">
...
@section('js')
  <script type="text/javascript" src="{{url('/')}}/public/backend/js/validate.min.js"></script>
